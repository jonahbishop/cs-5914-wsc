"""Copy of small LAN profile. Uses image-backed datasets for the nodes. Made for Group WSS. SELECT 3 nodes,
SELECT Ubuntu 20.04, ADD storage for the temporary filesystem, LEAVE the other options as default.
